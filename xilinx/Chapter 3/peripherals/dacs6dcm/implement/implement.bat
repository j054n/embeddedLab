...
xst -ifn xst.scr
move dacs6dcm_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\dacs6dcm_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc dacs6dcm_exdes.ucf dacs6dcm_exdes

echo 'Running map'
map -timing -pr b dacs6dcm_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm dacs6dcm_exdes -w routed.ncd routed.v
cd ..
