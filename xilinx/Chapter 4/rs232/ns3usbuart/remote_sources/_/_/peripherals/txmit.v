...
module txmit (input [7:0] tdin, output reg tbuf, input txrst,
              input clk16x, wrn, output reg txd, output reg parity);

reg clk1x_en, wrn1, wrn2;
reg [7:0] tsr=0;
reg [7:0] tbr=0;
reg [3:0] clkdiv=0;
